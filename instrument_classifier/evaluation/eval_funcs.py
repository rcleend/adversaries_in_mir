...
if __name__ == '__main__':
    log_path = os.path.join(misc_path, 'pretrained_models/logs/train.csv')
    ...
    print("Average SNR: ",compute_avg_std_snr(log_path))
    print("Adversarial accuracy",compute_adversarial_accuracy(log_path))
